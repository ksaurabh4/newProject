...
"use strict";
eval("\n\nvar _Login = __webpack_require__(/*! ./models/Login */ \"./src/js/models/Login.js\");\n\nvar _Login2 = _interopRequireDefault(_Login);\n\nvar _loginViews = __webpack_require__(/*! ./views/loginViews */ \"./src/js/views/loginViews.js\");\n\nvar loginView = _interopRequireWildcard(_loginViews);\n\nvar _formValidate = __webpack_require__(/*! ./views/form-validate */ \"./src/js/views/form-validate.js\");\n\nvar formValidate = _interopRequireWildcard(_formValidate);\n\nvar _domElements = __webpack_require__(/*! ./models/dom-elements */ \"./src/js/models/dom-elements.js\");\n\nvar _Tasks = __webpack_require__(/*! ./models/Tasks */ \"./src/js/models/Tasks.js\");\n\nvar _Tasks2 = _interopRequireDefault(_Tasks);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar state = {};\n\nvar loginUser = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            console.log('hello India');\n            //   const data = loginView.getInput();\n            //   console.log(data);\n            //   //validate the data in the form\n            //   //   const validate = formValidate.validateLoginFormData(\n            //   //     data.email,\n            //   //     data.password\n            //   //   );\n            //   //   if (validate === true) {\n            //   //     state.search = new Login(data.email, data.password);\n\n            //   //     try {\n            //   //       await state.search.loginAccount();\n            //   //       const data = state.search.result.data;\n            //   //       if (data.user) {\n            //   //         loginView.clearScreen();\n            //         loginView.renderLoginResult(data.user);\n            //         return data;\n            //       }\n            //     } catch (error) {\n            //       console.log(error);\n            //     }\n            //   }\n\n          case 1:\n          case 'end':\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function loginUser(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n// export const token = (async (data) => {\n//   const userData = await loginUser(data);\n//   console.log(userData.token);\n//   return userData.token;\n// })(data);\n\n// const getTasks = (token) => {\n//   state.task = new Task(token);\n//   state.task.getTasks();\n// };\n\n_domElements.elements.form.addEventListener('submit', function (e) {\n  e.preventDefault();\n  loginUser();\n  //window.location.href = '/dist/main.html';\n});\n// console.log(location.search);\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //tasks fetch and generate\n\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Task = function () {\n  function Task(token, description, status) {\n    _classCallCheck(this, Task);\n\n    this.token = token;\n    this.description = description;\n    this.status = status;\n  }\n\n  _createClass(Task, [{\n    key: 'createTask',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                _context.next = 3;\n                return (0, _axios2.default)({\n                  method: 'post',\n                  url: 'https://cors-anywhere.herokuapp.com/https://kumar-task-manager-api.herokuapp.com/tasks',\n                  data: {\n                    description: this.description,\n                    completed: this.status\n                  },\n                  headers: { Authorization: 'Bearer ' + this.token }\n                });\n\n              case 3:\n                res = _context.sent;\n\n                this.result = res;\n                console.log(this.result);\n                _context.next = 11;\n                break;\n\n              case 8:\n                _context.prev = 8;\n                _context.t0 = _context['catch'](0);\n\n                console.log(_context.t0);\n\n              case 11:\n              case 'end':\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 8]]);\n      }));\n\n      function createTask() {\n        return _ref.apply(this, arguments);\n      }\n\n      return createTask;\n    }()\n  }, {\n    key: 'getTasks',\n    value: function () {\n      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                _context2.prev = 0;\n                _context2.next = 3;\n                return (0, _axios2.default)({\n                  method: 'get',\n                  url: 'https://cors-anywhere.herokuapp.com/https://kumar-task-manager-api.herokuapp.com/tasks',\n                  headers: { Authorization: 'Bearer ' + this.token }\n                });\n\n              case 3:\n                res = _context2.sent;\n\n                this.result = res;\n                console.log(res);\n                _context2.next = 11;\n                break;\n\n              case 8:\n                _context2.prev = 8;\n                _context2.t0 = _context2['catch'](0);\n\n                console.log(_context2.t0);\n\n              case 11:\n              case 'end':\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this, [[0, 8]]);\n      }));\n\n      function getTasks() {\n        return _ref2.apply(this, arguments);\n      }\n\n      return getTasks;\n    }()\n  }]);\n\n  return Task;\n}();\n\nexports.default = Task;\n\n//# sourceURL=webpack:///./src/js/models/Tasks.js?");

/***/ }),

/***/ "./src/js/models/dom-elements.js":
/*!***************************************!*\
  !*** ./src/js/models/dom-elements.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderLoginResult = exports.renderLoginForm = exports.clearScreen = exports.getInput = undefined;\n\nvar _domElements = __webpack_require__(/*! ../models/dom-elements */ \"./src/js/models/dom-elements.js\");\n\nvar getInput = exports.getInput = function getInput() {\n  return {\n    email: _domElements.elements.email,\n    password: _domElements.elements.password\n  };\n};\n\nvar clearScreen = exports.clearScreen = function clearScreen() {\n  _domElements.elements.body.innerHTML = '';\n};\n\nvar renderLoginForm = exports.renderLoginForm = function renderLoginForm(user) {\n  var markup = '<form class=\"form\" id=\"form\">\\n\\n    <h1>Login</h1>\\n    <div class=\"form-control\">\\n      <label for=\"email\">Email</label>\\n      <input type=\"text\" id=\"email\" placeholder=\"Enter Email\" />\\n      <small>Error Messege</small>\\n    </div>\\n    <div class=\"form-control\">\\n      <label for=\"password\">Password</label>\\n      <input type=\"password\" id=\"password\" placeholder=\"Enter password\" />\\n      <small>Error Messege</small>\\n    </div>\\n    <a id=\"switch-forms\">click to create new account</a>\\n    <button type=\"submit\" id=\"login-btn\">Login</button>\\n</form>';\n  _domElements.elements.body.insertAdjacentHTML('beforeend', markup);\n};\n\nvar renderLoginResult = exports.renderLoginResult = function renderLoginResult(user) {\n  var markup = '<div class=\"after-login\"><p>Hello ' + user.name + ', You successfully logged in your account!</p>\\n  <button class=\"btn\" id=\"logout-button\">Logout</button><button class=\"btn\" id=\"getProfile\">Profile</button>\\n  <div class=\"task-container\" id=\"task-container\"><h2>Your Task List</h2><button class=\"btn\" id=\"get-task-btn\"> Click to get your tasks</button><div class=\"tasks\" id=\"tasks\"></div></div></div>';\n  _domElements.elements.body.innerHTML = markup;\n};\n\n//# sourceURL=webpack:///./src/js/views/loginViews.js?");
